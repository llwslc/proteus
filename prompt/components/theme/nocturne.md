...
- Meter：黄铜气压计——`meter-gauge-w` 半圆盘居左，底弧 `gilt-30`，`gilt-bright` 指针扫向值位、`gilt` 中轴钉；值弧与 mono `fs-24` 大数字同染 tone 色，primary 档取 `primary-bright`；右侧铭牌 label 在上、数字在下，1px `gilt-30` 竖线钉在盘边。
