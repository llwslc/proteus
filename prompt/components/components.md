...
> **文字对比**：`-mute`、说明、错误这类读内容的功能字在其栖身表面 ≥4.5:1，焦点描边／状态图标 ≥3:1。强调色当正文／焦点走哪一档，由各 theme 按自己的身份定，两条都成立、无高下：**留满饱和的招牌色**（响度优先，深底多半直接达标、浅底是明确的响度取舍），或**换本家族更深一档**换正文对比——在该 theme 文档写明走哪条即可。纯装饰字、商标字、禁用态、纯填充上的反色前景不在此列（填充按其反色前景档判定）。
