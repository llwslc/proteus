...
- **浮层与触发器的渲染缝、各 kit 同值**：Tooltip、Popover、PreviewCard 与 NavigationMenu 下拉 `10`；Select、Combobox、Autocomplete、Menu、Menubar `6`；ContextMenu 贴指针不加缝；原始 `sideOffset` 按本套框厚自调，子菜单另见 §6.1。
