...
按「面板清单」摆出要演示的控件：顶部栏含 logo、NavigationMenu 主导航、状态徽章、主题图标与时钟，接左侧 sticky 索引——按清单分组，锚点平滑跳转，接 hero——eyebrow、大标题、描述、数据条与主题装饰件，装饰件的形态与落位由 theme 定，接两栏面板网格——版式见下表，根包 `ToastProvider`，整页挂 theme 氛围层。
