...
- context：trigger = 文本投放区（demo 装置，App 层持有——`<kit>-context__zone` 盒包提示文案，`min-height` 走 App 层的 `--<kit>-contextmenu-min-h`、各 kit 同值 `132px`，Tab 可聚焦）；4 个 MenuItem + 1 分隔，前 2 带快捷键，第 3 项 `disabled`，分隔后末项 `danger`。
