...
- 代号 **NOCTURNE**（夜曲），取维多利亚暗夜温室的《颠茄夜园》图版册：深茄紫黑的丝绒衬底上，黄铜发丝线压出双线画框，酒红丝绒作填充，骨白衬线字押着宽字距；缠枝蔓叶自框角探入，花朵是它的活动部件——枝上花开（推进）、月相盈亏（读数）、端花随值绽（可拨）：只有能拨的那件长出可抓的花。每个控件都是一页夜册图版，也是一株夜里睁眼的花。
