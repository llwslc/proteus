...
For every kit (list derived from `src/kits/*/theme/tokens.css` ∩ `prompt/themes/
...
`prompt/themes/<kit>.md` and it must report the drift; revert and it passes —
