...
export default function Loader() {
  return (
    <div className="hanabi-loader" role="status" aria-label="Loading HANABI">
      <div className="hanabi-loader__stage">
        ...
        <svg className="hanabi-loader__spark" viewBox="0 0 48 48" aria-hidden="true">
          <path
            className="hanabi-loader__spark-shade"
            transform="translate(2.25 2.25)"
            d="M24 4c1.4 8.4 5 12.4 13.6 14-8.6 2-12.2 6-13.6 14.6C22.6 24 19 20 10.4 18 19 16.4 22.6 12.4 24 4Z"
          />
