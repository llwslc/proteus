...
export function ScrollArea({
  ...
  if (variant === "popup") {
    return (
      <BaseScrollArea.Root
        className={cx("hanabi-scrollarea", "hanabi-scrollarea--popup", className)}
        {...props}
      >
        <BaseScrollArea.Viewport className="hanabi-scrollarea__viewport">
          {children}
        </BaseScrollArea.Viewport>
        <BaseScrollArea.Scrollbar className="hanabi-scrollarea__bar">
          <BaseScrollArea.Thumb className="hanabi-scrollarea__thumb" />
        </BaseScrollArea.Scrollbar>
      </BaseScrollArea.Root>
    );
  }
  return (
    <BaseScrollArea.Root className={cx("hanabi-scrollarea", className)} {...props}>
      {children}
    </BaseScrollArea.Root>
  );
}
...
export function ScrollAreaViewport({
  ...
  return (
    <BaseScrollArea.Viewport
      className={cx("hanabi-scrollarea__viewport", className)}
      {...props}
    />
  );
}
...
export function ScrollAreaContent({
  ...
  return (
    <BaseScrollArea.Content
      className={cx("hanabi-scrollarea__content", className)}
      {...props}
    />
  );
}
