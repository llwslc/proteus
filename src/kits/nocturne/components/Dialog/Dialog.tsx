...
import { ModalVine, SprigMark, XIcon } from "../icons";
import "./Dialog.css";
    ...
    <BaseDialog.Root open={open} onOpenChange={onOpenChange}>
      ...
      <BaseDialog.Portal>
        ...
        <BaseDialog.Viewport className="nocturne-viewport">
          ...
          >
            <span className="nocturne-dialog__corner nocturne-dialog__corner--tl" aria-hidden="true">
              <SprigMark />
            </span>
            <span className="nocturne-dialog__corner nocturne-dialog__corner--tr" aria-hidden="true">
              <SprigMark />
            </span>
            <span className="nocturne-dialog__corner nocturne-dialog__corner--bl" aria-hidden="true">
              <SprigMark />
            </span>
            <span className="nocturne-dialog__corner nocturne-dialog__corner--br" aria-hidden="true">
              <SprigMark />
            </span>
            <BaseDialog.Close
