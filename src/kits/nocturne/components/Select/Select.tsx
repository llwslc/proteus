...
export function Select<Value extends string = string>({
  ...
  return (
    ...
    >
      ...
      >
        <BaseSelect.Value className="nocturne-select__value" placeholder={placeholder} />
        <BaseSelect.Icon className="nocturne-select__icon">
          <ChevronDownIcon />
        </BaseSelect.Icon>
      </BaseSelect.Trigger>
      <BaseSelect.Portal>
        <BaseSelect.Positioner
          className="nocturne-elevation nocturne-select__positioner"
          sideOffset={6}
          alignItemWithTrigger={false}
          side={side}
          align={align}
        >
          <BaseSelect.Popup className="nocturne-popup nocturne-velvet--pop nocturne-drift nocturne-popup-list nocturne-select__popup">
