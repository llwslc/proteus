  ...
  return (
    <BaseAutocomplete.Root items={labels} {...props}>
      <BaseAutocomplete.InputGroup
        className={cx(
          "nocturne-field nocturne-ring nocturne-ring--within nocturne-autocomplete",
          className,
        )}
      >
      ...
      <BaseAutocomplete.Portal>
        <BaseAutocomplete.Positioner
          ...
          align={align}
        >
          <BaseAutocomplete.Popup className="nocturne-surface nocturne-unveil nocturne-popup nocturne-popup-list nocturne-autocomplete__popup">
