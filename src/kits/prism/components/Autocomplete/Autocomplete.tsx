  ...
  return (
    <BaseAutocomplete.Root items={labels} {...props}>
      <BaseAutocomplete.InputGroup
        className={cx("prism-surface prism-autocomplete", className)}
      >
        <BaseAutocomplete.Input
          id={inputId}
          aria-label={label ?? placeholder}
          placeholder={placeholder}
          className="prism-autocomplete__input"
        />
      </BaseAutocomplete.InputGroup>
      <BaseAutocomplete.Portal>
        <BaseAutocomplete.Positioner
          ...
          align={align}
        >
          <BaseAutocomplete.Popup className="prism-surface prism-pop prism-popup prism-popup-list prism-autocomplete__popup">
            <BaseAutocomplete.Empty className="prism-autocomplete__empty">
              {emptyText}
            </BaseAutocomplete.Empty>
            <ScrollArea variant="popup">
              <BaseAutocomplete.List className="prism-autocomplete__list">
                {(item: string) => (
