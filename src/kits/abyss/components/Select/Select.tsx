  ...
  return (
    ...
    >
      <span className={cx("abyss-select__field", className)}>
        <BaseSelect.Trigger id={id ?? autoId} className="abyss-select__trigger">
          <BaseSelect.Value>
            {(val) => {
      ...
      <BaseSelect.Portal>
        ...
        >
          <BaseSelect.Popup className="abyss-surface abyss-anim-pop abyss-select__popup">
            <div className="abyss-select__list">
              {items.map((it) => (
                ...
                >
                  <span className="abyss-select__item-indicator">
