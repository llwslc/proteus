      ...
      <BaseTooltip.Root open={open} onOpenChange={setOpen}>
        ...
        <BaseTooltip.Portal>
          <BaseTooltip.Positioner
            className="abyss-elevation abyss-tooltip__positioner"
            side={side}
            sideOffset={sideOffset}
          >
            <BaseTooltip.Popup className="abyss-anim-pop abyss-tooltip__popup">
              <span className="abyss-surface abyss-tooltip__surface">{content}</span>
