...
export function Dialog({
  ...
  return (
    <BaseDialog.Root open={open} onOpenChange={onOpenChange}>
      ...
      <BaseDialog.Portal>
        <BaseDialog.Backdrop className="abyss-scrim-backdrop" />
        <BaseDialog.Viewport className="abyss-overlay-viewport">
          <BaseDialog.Popup
            ref={popupRef}
            initialFocus={popupRef}
            className={cx("abyss-elevation abyss-dialog__popup", className)}
          >
            <div className="abyss-surface abyss-dialog__surface">
              ...
              <BaseDialog.Close
                render={
                  <Button
                    variant="icon"
                    aria-label="Close"
                    className="abyss-modal-x abyss-modal-x--danger abyss-dialog__x"
                  >
                    <XIcon />
                  </Button>
                }
              ...
              {footer != null ? <div className="abyss-modal-actions">{footer}</div> : null}
            </div>
          </BaseDialog.Popup>
        </BaseDialog.Viewport>
      </BaseDialog.Portal>
