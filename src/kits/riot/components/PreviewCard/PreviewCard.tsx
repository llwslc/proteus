    ...
    <BasePreviewCard.Root open={open} onOpenChange={setOpen} {...props}>
      ...
      <BasePreviewCard.Portal>
        <BasePreviewCard.Positioner
          className="riot-lift riot-preview__positioner"
          side={side}
          align={align}
          sideOffset={sideOffset}
        >
          <BasePreviewCard.Popup className="riot-pop riot-preview__popup">
            <span className="riot-surface riot-preview__surface">
              <div className="riot-preview__body">{children}</div>
            </span>
            <BasePreviewCard.Arrow className="riot-connector" />
